...
export default {
  ...
  data() {
    return {
      ...
      rules:{
        eid:[{
          required:true,message:'企业编号不能为空',triger:'blur'
        }],
        name:[{
          required:true,message:'企业名称不能为空',triger:'blur'
        }],
        short_name:[{
          required:true,message:'企业简称不能为空',triger:'blur'
        }],
        intro:[{
          required:true,message:'企业简介不能为空',triger:'blur'
        }],
      },
